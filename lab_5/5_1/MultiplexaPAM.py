...
from Modulacion import Modulacion  # grc-generated hier_block
...
class MultiplexaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._fs_range = Range(0, 10e3, 1, 2e3, 200)
        ...
        self._DEM_range = Range(0, 100, 1, 0, 200)
        self._DEM_win = RangeWidget(self._DEM_range, self.set_DEM, "demodular", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._DEM_win)
        ...
        self.filter_fft_low_pass_filter_0 = filter.fft_filter_fff(1, firdes.low_pass(10, samp_rate, fs/4, 100, window.WIN_HANN, 6.76), 1)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_delay_1 = blocks.delay(gr.sizeof_float*1, DEM)
        ...
        self.analog_sig_source_x_0_1_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, fm, Am, 0, 0)
        self.analog_sig_source_x_0_1 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, fm, Am, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, fm, Am, 0, 0)
        ...
        self.Modulacion_0_1_0 = Modulacion(
            d=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        self.Modulacion_0_1 = Modulacion(
            d=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        self.Modulacion_0_0 = Modulacion(
            d=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        self.Modulacion_0 = Modulacion(
            d=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.Modulacion_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.Modulacion_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.Modulacion_0_0, 0), (self.blocks_delay_0, 0))
        self.connect((self.Modulacion_0_1, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.Modulacion_0_1_0, 0), (self.blocks_delay_0_1, 0))
        self.connect((self.ModuladorPAM_0, 0), (self.filter_fft_low_pass_filter_0, 0))
        self.connect((self.ModuladorPAM_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Modulacion_0, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.Modulacion_0_0, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.Modulacion_0_1, 0))
        self.connect((self.analog_sig_source_x_0_1_0, 0), (self.Modulacion_0_1_0, 0))
        ...
        self.connect((self.blocks_delay_1, 0), (self.ModuladorPAM_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.Modulacion_0.set_samp_rate(self.samp_rate)
        self.Modulacion_0_0.set_samp_rate(self.samp_rate)
        self.Modulacion_0_1.set_samp_rate(self.samp_rate)
        self.Modulacion_0_1_0.set_samp_rate(self.samp_rate)
        ...
        self.filter_fft_low_pass_filter_0.set_taps(firdes.low_pass(10, self.samp_rate, self.fs/4, 100, window.WIN_HANN, 6.76))
    ...
    def set_fs(self, fs):
        self.fs = fs
        self.Modulacion_0.set_fs(self.fs)
        self.Modulacion_0_0.set_fs(self.fs)
        self.Modulacion_0_1.set_fs(self.fs)
        self.Modulacion_0_1_0.set_fs(self.fs)
    ...
    def set_fm(self, fm):
        ...
        self.analog_sig_source_x_0_1_0.set_frequency(self.fm)
    ...
    def set_DEM(self, DEM):
        self.DEM = DEM
        self.blocks_delay_1.set_dly(self.DEM)
    ...
    def set_D(self, D):
        self.D = D
        self.Modulacion_0.set_d(self.D)
        self.Modulacion_0_0.set_d(self.D)
        self.Modulacion_0_1.set_d(self.D)
        self.Modulacion_0_1_0.set_d(self.D)
    ...
    def set_Am(self, Am):
        ...
        self.analog_sig_source_x_0_1_0.set_amplitude(self.Am)
