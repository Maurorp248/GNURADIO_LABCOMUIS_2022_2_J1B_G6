...
class moduladorPWM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fc_range = Range(50e6, 1e9, 1e6, 50e6, 200)
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "Freciencia de portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._AMP_range = Range(-3, 3, 0.1, 1, 200)
        self._AMP_win = RangeWidget(self._AMP_range, self.set_AMP, "AMPLITU DC", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, fs, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_CONST_WAVE, fm, AMP, 0, 0)
        self.ModulosEfren_Compara_0 = ModulosEfren.Compara()
        self._DC_range = Range(-10, 10, 100e-3, 0, 200)
        self._DC_win = RangeWidget(self._DC_range, self.set_DC, "Nivel de diente de sierra", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.qtgui_time_sink_x_0, 2))
