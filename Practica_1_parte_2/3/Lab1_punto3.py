...
class Lab1_punto3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lab1_Punto3", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab1_Punto3")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Documentos/Lab_G6_MAURICIO/PRACTICA_1_PARTE_2/Audios de prueba-20221024T165741Z-001/Audios de prueba/rebelion_joearroyo.wav', True)
