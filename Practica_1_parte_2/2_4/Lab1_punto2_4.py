...
class Lab1_punto2_4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab1_Punto2_4", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab1_Punto2_4")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab1_punto2_4")
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, freq, 1, 0, 0)
...
def main(top_block_cls=Lab1_punto2_4, options=None):
