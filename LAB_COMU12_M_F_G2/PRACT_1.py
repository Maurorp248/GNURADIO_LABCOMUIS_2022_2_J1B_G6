...
import PRACT_1_promedios_de_tiempos as promedios_de_tiempos  # embedded python block



from gnuradio import qtgui

class PRACT_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "PRACT_1")
        ...
        self.qtgui_number_sink_4.set_title("DESVIACION_STANDARD")
        ...
        self.qtgui_number_sink_3.set_title("POTENCIA_PROMEDIO")
        ...
        self.promedios_de_tiempos = promedios_de_tiempos.blk()
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_vector_source_x_0, 0), (self.promedios_de_tiempos, 0))
        self.connect((self.blocks_vector_source_x_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.promedios_de_tiempos, 0), (self.qtgui_number_sink_0, 0))
        self.connect((self.promedios_de_tiempos, 1), (self.qtgui_number_sink_1, 0))
        self.connect((self.promedios_de_tiempos, 2), (self.qtgui_number_sink_2, 0))
        self.connect((self.promedios_de_tiempos, 3), (self.qtgui_number_sink_3, 0))
        self.connect((self.promedios_de_tiempos, 4), (self.qtgui_number_sink_4, 0))
...
def main(top_block_cls=PRACT_1, options=None):
