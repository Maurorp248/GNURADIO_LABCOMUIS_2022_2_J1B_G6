...
class Lab_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_2")
        ...
        # Blocks
        ##################################################
        self._A_range = Range(1, 100, 1, 1, 200)
...
def main(top_block_cls=Lab_2, options=None):
