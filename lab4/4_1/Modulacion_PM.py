...
class Modulacion_PM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "Frecuemcia portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._GTX_range = Range(0, 30, 1, 1, 200)
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "Ganacia del transmisor", "counter_slider", float, QtCore.Qt.Horizontal)
