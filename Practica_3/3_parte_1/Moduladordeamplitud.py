...
# Title: Lab_3_Modulador de amplitud
# Author: Elian Mauricio Rojas Poveda J1B_G6
# Copyright: Uis
...
class Moduladordeamplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lab_3_Modulador de amplitud", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab_3_Modulador de amplitud")
        ...
        self._fm_win = RangeWidget(self._fm_range, self.set_fm, "frecuencia de mensaje fm", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fm_win)
        self._fc_range = Range(50e6, 2.2e9, 1e6, 50e6, 200)
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "Frecuencia de Portadora fc", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._Ka_range = Range(0, 4, 100e-3, 1, 200)
        self._Ka_win = RangeWidget(self._Ka_range, self.set_Ka, "Coeficiente de solubilidad ka", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._Ka_win)
        self._GTX_range = Range(0, 30, 1, 0, 200)
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "Ganancia del transmisor GTX", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._GTX_win)
        self._Am_range = Range(0, 4, 100e-3, 1, 200)
        self._Am_win = RangeWidget(self._Am_range, self.set_Am, "Amplitud mensaje Am", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._Am_win)
        self._Ac_range = Range(0, 1, 1e-3, 125e-3, 200)
        self._Ac_win = RangeWidget(self._Ac_range, self.set_Ac, "Amplitud de portadora Ac", "counter_slider", float, QtCore.Qt.Horizontal)
